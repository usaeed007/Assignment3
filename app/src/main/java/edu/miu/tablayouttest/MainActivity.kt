...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAdd.setOnClickListener {
            if (binding.etAndroidVersion.text.isNotEmpty() && binding.etAndroidCodeNm.text.isNotEmpty())
                addRow(
    ...
    private fun addRow(versionName: String, codeName: String) {
        ...
        tvVersion.setTextColor(ContextCompat.getColor(this, R.color.white))
        tvVersion.text = versionName

        val tvCodeName = TextView(this)
        tvCodeName.setTextColor(ContextCompat.getColor(this, R.color.white))
